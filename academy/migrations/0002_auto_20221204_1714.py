...
def beginning(apps, schema_editor):
    ...
    "Mektep -lline-бұл кіші, орта және орта мектеп бағдарламалары бойынша төрт мыңға жуық бейне сабақтар жиналған және құрылымдалған сайт, mektep-online YouTube арналарында математика, химия, биология, физика, геометрия сабақтары ұсынылған. Ал 2022 жылдың қыркүйегінен бастап ARMANkids 1-4 сыныптары үшін ойынға негізделген білім беру мазмұны пайда болды", - деді платформаны әзірлеген жеке қордың өкілі Балия Әкімбекова."""
    news.photo = 'images/news6.jpeg' 
    news.save()
